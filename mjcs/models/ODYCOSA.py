...
class ODYCOSA(CaseTable, TableBase):
    '''MDEC Appellate Court of Maryland Cases'''
    __tablename__ = 'odycosa'
    is_root = True
    ...
    case = relationship('Case', backref=backref('odycosa', uselist=False))

    __table_args__ = (Index('ixh_odycosa_case_number', 'case_number', postgresql_using='hash'),)
...
class ODYCOSACaseTable(CaseTable):
    @declared_attr
    def case_number(self):
        return Column(String, ForeignKey('odycosa.case_number', ondelete='CASCADE'), nullable=False)

class ODYCOSAReferenceNumber(ODYCOSACaseTable, TableBase):
    __tablename__ = 'odycosa_reference_numbers'
    __table_args__ = (Index('ixh_odycosa_reference_numbers_case_number', 'case_number', postgresql_using='hash'),)
    odycosa = relationship('ODYCOSA', backref='reference_numbers')

    id = Column(Integer, primary_key=True)
    ref_num = Column(String, nullable=False)
    ref_num_type = Column(String, nullable=False, enum=True)

class ODYCOSAInvolvedParty(ODYCOSACaseTable, TableBase):
    __tablename__ = 'odycosa_involved_parties'
    __table_args__ = (Index('ixh_odycosa_involved_parties_case_number', 'case_number', postgresql_using='hash'),)
    odycosa = relationship('ODYCOSA', backref='involved_parties')
    ...
    attorneys = relationship('ODYCOSAAttorney')
...
class ODYCOSAAttorney(ODYCOSACaseTable, TableBase):
    __tablename__ = 'odycosa_attorneys'
    __table_args__ = (Index('ixh_odycosa_attorneys_case_number', 'case_number', postgresql_using='hash'),)
    odycosa = relationship('ODYCOSA', backref='attorneys')
    ...
    state = Column(String)
    zip_code = Column(String)
    party_id = Column(Integer, ForeignKey('odycosa_involved_parties.id'))
...
class ODYCOSAJudgment(ODYCOSACaseTable, TableBase):
    __tablename__ = 'odycosa_judgments'
    __table_args__ = (Index('ixh_odycosa_judgment_case_number', 'case_number', postgresql_using='hash'),)
    odycosa = relationship('ODYCOSA', backref='judgments')
...
class ODYCOSACourtSchedule(ODYCOSACaseTable, TableBase):
    __tablename__ = 'odycosa_court_schedule'
    __table_args__ = (Index('ixh_odycosa_court_schedule_case_number', 'case_number', postgresql_using='hash'),)
    odycosa = relationship('ODYCOSA', backref='court_schedule')
...
class ODYCOSADocument(ODYCOSACaseTable, TableBase):
    __tablename__ = 'odycosa_documents'
    __table_args__ = (Index('ixh_odycosa_documents_case_number', 'case_number', postgresql_using='hash'),)
    odycosa = relationship('ODYCOSA', backref='documents')

...
class KCharge(KCaseTable, TableBase):
    ...
    jail_unsuspended_years = Column(Integer, nullable=True)
    jail_unsuspended_months = Column(Integer, nullable=True)
    jail_unsuspended_days = Column(Integer, nullable=True)
    jail_unsuspended_hours = Column(Integer, nullable=True)
...
class KSentencingNetTools(KCaseTable, TableBase):
    ...
    id = Column(Integer, primary_key=True)
    serve_time_years = Column(Integer, nullable=True)
    serve_time_months = Column(Integer, nullable=True)
    serve_time_days = Column(Integer, nullable=True)
    serve_time_hours = Column(Integer, nullable=True)
    probation_years = Column(Integer, nullable=True)
    probation_months = Column(Integer, nullable=True)
    probation_days = Column(Integer, nullable=True)
    probation_hours = Column(Integer, nullable=True)

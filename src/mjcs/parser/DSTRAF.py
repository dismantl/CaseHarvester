...
class DSTRAFParser(CaseDetailsParser):
    ...
    #     except ParserError:
    #         return
    #     schedule = DSTRAFTrial(case_number=self.case_number)
    ...
    def charge(self, db, soup):
        ...
        charge.contributed_to_accident = self.value_multi_column(section,'Contributed to Accident\?:')
        charge.personal_injury = self.value_multi_column(section,'Personal Injury\?:')
        charge.property_damage = self.value_multi_column(section,'Property Damage\?:',ignore_missing=True)
    ...
    def defendant(self, db, soup):
        ...
        #     except ParserError:
        #         break
        #     alias = DSTRAFDefendantAlias(case_number=self.case_number)
